            ...
            <ul class="nav nav-tabs mb-3" id="myTab0" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active"
                       id="home-tab0"  type="button" href="{{route('index')}}">
                    ...
                    <ul class="absolute-menu submenu">
                        ...
                        <li><a href="{{route('index')}}">بروز رسانی</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="profile-tab0" type="button" href="{{route('banner.index')}}">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <ul class="absolute-menu submenu">
                        <li><a href="{{route('vendors.index')}}">همه تبلیغ ها</a></li>
                        <li><a href="{{route('vendors.create')}}">افزودن جدید</a></li>
                        <li><a href="{{route('first-page.index')}}">دسته بندی تبلیغات</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="comment-tab0" role="tab" type="button" href="{{route('comments.index')}}">
                ...
                <li class="nav-item" role="presentation">
                    ...
                    <ul class="absolute-menu submenu">
                        <li><a href="<?= route("templates.index")?>">لیست قالب ها</a></li>
                        <li><a href="#">افزودن</a></li>
                    </ul>
                </li>
                <li class="nav-item" role="presentation">
