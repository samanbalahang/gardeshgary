...
<head>
    ...
    <script src="{{url('/')}}/mainMgn/assets/js/jquery-3.6.0.min.js"></script>
    <link rel="stylesheet" href="{{url('/')}}/mainMgn/assets/css/style.min.css">
    <link rel="stylesheet" href="{{url('/')}}/mainMgn/assets/css/font.css">
    <style>
...
<div class="loader" id="loader">
    <img src="{{url('/')}}/mainMgn/assets/images/sambal.png" alt="sambal">
</div>
<!--Main Navigation-->
<header>
    <!-- Sidebar -->
